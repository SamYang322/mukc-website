				...
				<?php if ( ( is_page() && ! is_front_page() ) || ( is_single() && ! is_front_page() ) ) : ?>
					...
					elseif ( is_home() && is_front_page() ) :
						if ( is_active_sidebar( 'site-branding-text' ) ) :
							...
							?>
							<h1  style = "font-family:'Arial Black'; font-size:38px; color:Gold"><?php esc_html( bloginfo( 'name' ) ); ?></h1>
							<p class="site-description text-white" style = "font-size:22px"><?php echo esc_html( get_bloginfo( 'description', 'display' ) ); ?></p>
							<?php
						endif;
						?>
