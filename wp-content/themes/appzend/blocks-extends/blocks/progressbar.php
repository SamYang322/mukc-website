<?php
add_filter( 'render_block_core/paragraph', 'ikreate_themes_render_progressbar_block_variation', 10, 2 );
/**
 ...
 * @return string
 */
function ikreate_themes_render_progressbar_block_variation( string $html, array $block ): string {
    ...
    // Escape the progressbarLayout and other attributes before rendering them
...
add_filter( 'ikreate_themes_block_inline_css', 'ikreate_themes_add_progressbar_support_css', 10, 2 );
/**
 ...
 * @return string
 */
function ikreate_themes_add_progressbar_support_css( string $css, string $html ): string {
...
add_filter( 'ikreate_themes_block_inline_js', 'ikreate_themes_add_progressbar_support_js', 10, 2 );
function ikreate_themes_add_progressbar_support_js( string $js, string $html ): string {
    /** clasic theme compatible */
    if( !$html){
        global $post;
