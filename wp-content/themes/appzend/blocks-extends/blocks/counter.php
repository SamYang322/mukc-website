<?php
add_filter( 'render_block_core/paragraph', 'ikreate_themes_render_counter_block_variation', 10, 2 );
/**
 ...
 * @return string
 */
function ikreate_themes_render_counter_block_variation( string $html, array $block ): string {
...
add_filter( 'ikreate_themes_block_inline_js', 'ikreate_themes_block_add_counter_js', 10, 2 );
 ...
 * @return string
 */
function ikreate_themes_block_add_counter_js( string $js, string $html ): string {
