 ...
 * @return void
 */
if(!function_exists('appzend_register_block_patterns')){

	function appzend_register_block_patterns() {

		$patterns = array();

		$block_pattern_categories = array(
			'appzend' => array( 'label' => __( 'Appzend Themes', 'appzend' ) )
		);

		$block_pattern_categories = apply_filters( 'appzend_register_block_patterns', $block_pattern_categories );
		...
		register_block_style(
			...
			array(
				'name'         => 'primary-button',
				'label'        => esc_html__( 'Primary Button', 'appzend' ),
				'inline_style' => '
		...
		register_block_style(
			...
			array(
				...
				'label'        => esc_html__( 'Secondary Button', 'appzend' ),
				'inline_style' => '
		...
		register_block_style(
			...
			array(
				'name'         => 'no-border',
				'label'        => esc_html__( 'No Border', 'appzend' ),
				'inline_style' => '
		...
		register_block_style(
			...
			array(
				'name'         => 'video',
				'control__label' => 'shiv',
				'label'        => esc_html__( 'Video Icon', 'appzend' ),
				'inline_style' => '
...
add_action( 'init', 'appzend_register_block_patterns', 9 );